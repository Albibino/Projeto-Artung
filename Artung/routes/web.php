...
Route::get('/banned', function (){return view('banned');})->name('banned.notice');
Route::get('/AcessoNegado', function (){return view('acessonegado');})->name('AcessoNegado.notice');
...
Route::get('/profile/{user}', function (User $user) { return view('profile.show', ['user' => $user]);})->middleware(['auth', 'banned'])->name('profile.show');

Route::middleware('auth', 'banned')->group(function () {
    Route::get('/profile/{user}'       , [ProfileController::class, 'show'])->name('profile.show')->middleware('auth', 'banned');
